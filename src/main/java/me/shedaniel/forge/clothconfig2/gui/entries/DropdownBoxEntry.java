...
import me.shedaniel.forge.clothconfig2.gui.widget.DynamicEntryListWidget.SmoothScrollingSettings;
import me.shedaniel.forge.clothconfig2.gui.widget.DynamicNewSmoothScrollingEntryListWidget.Interpolation;
import me.shedaniel.forge.clothconfig2.gui.widget.DynamicNewSmoothScrollingEntryListWidget.Precision;
    ...
    public static class DefaultDropdownMenuElement<R> extends DropdownMenuElement<R> {
        ...
        public void lateRender(int mouseX, int mouseY, float delta) {
            ...
            if (currentElements.isEmpty()) {
                ...
                fontRenderer.drawStringWithShadow(s, lastRectangle.x + getCellCreator().getCellWidth() / 2 - fontRenderer.getStringWidth(s) / 2, lastRectangle.y + lastRectangle.height + 3, -1);
            }
